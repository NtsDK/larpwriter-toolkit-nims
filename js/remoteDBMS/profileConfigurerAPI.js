...
RemoteDBMS.prototype.createProfileItem= function(name, type, value, toEnd, selectedIndex, callback){
    "use strict";
    RemoteDBMS._simplePut("createProfileItem", [name, type, value, toEnd, selectedIndex], callback);
};

//profile configurer
RemoteDBMS.prototype.swapProfileItems = function(index1, index2, callback){
    "use strict";
    RemoteDBMS._simplePut("swapProfileItems", [index1, index2], callback);
};

//profile configurer
RemoteDBMS.prototype.removeProfileItem = function(index, name, callback){
    "use strict";
    RemoteDBMS._simplePut("removeProfileItem", [index, name], callback);
};

//profile configurer
RemoteDBMS.prototype.changeProfileItemType = function(name, newType, callback){
    "use strict";
    RemoteDBMS._simplePut("changeProfileItemType", [name, newType], callback);
};
...
RemoteDBMS.prototype.isProfileItemNameUsed = function(name, callback){
    "use strict";
    RemoteDBMS._simpleGet("isProfileItemNameUsed", [name],  callback);
};

//profile configurer
RemoteDBMS.prototype.renameProfileItem = function(newName, oldName, callback){
    "use strict";
    RemoteDBMS._simplePut("renameProfileItem", [newName, oldName], callback);
};

//profile configurer
RemoteDBMS.prototype.updateDefaultValue = function(name, value){
    "use strict";
    RemoteDBMS._simplePut("updateDefaultValue", [name, value]);
};