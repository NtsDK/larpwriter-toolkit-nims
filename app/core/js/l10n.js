...
exports.localizeStatic = (el) => {
    el = el || document;
    U.nl2array(U.qees(el, '[l10n-id]')).map(el2 => U.addEl(U.clearEl(el2), U.makeText(exports.getValue(U.getAttr(el2, 'l10n-id')))));
    U.nl2array(U.qees(el, '[l10n-placeholder-id]')).map(el2 => U.setAttr(el2, 'placeholder', exports.getValue(U.getAttr(el2, 'l10n-placeholder-id'))));
    U.nl2array(U.qees(el, '[l10n-title]')).map(el2 => U.setAttr(el2, 'title', exports.getValue(U.getAttr(el2, 'l10n-title'))));
};
