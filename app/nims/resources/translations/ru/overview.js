module.exports = {
  ...
  'story-completeness-value': '{{percent}}% ({{finished}} из {{all}} историй)',
  'general-completeness-value': '{{percent}}% ({{finished}} из {{all}} адаптаций)',
  'relation-completeness-value': '{{percent}}% ({{finished}} из {{all}} отношений)',
