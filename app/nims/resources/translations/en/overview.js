module.exports = {
  ...
  'story-completeness-value': '{{percent}}% ({{finished}} from {{all}} stories)',
  'general-completeness-value': '{{percent}}% ({{finished}} from {{all}} subjective visions)',
  'relation-completeness-value': '{{percent}}% ({{finished}} from {{all}} relations)',
