...
const config = {
    ...
    plugins: [
        new webpack.ProvidePlugin({
            ...
            Constants: 'dbms-nims/nimsConstants',
            CU: 'dbms-core/commonUtils',
            Errors: 'dbms-core/errors',
            // CU: 'core/commonUtils',
            // Errors: 'core/errors',
            // CU: ['core', 'CU'],
            // Errors: ['core', 'Errors'],
...
module.exports = (env, argv) => {
    ...
    case 'standalone':
        ...
        config.resolve.alias.push({
            ...
            alias: 'dbms-nims/standaloneApis',
            name: 'apis',
            onlyModule: true
        });
        config.resolve.alias.push({
            // alias: 'core/serverDbmsFactory',
            alias: 'dbms-core/serverDbmsFactory',
