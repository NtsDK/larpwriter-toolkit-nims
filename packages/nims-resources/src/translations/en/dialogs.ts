export const dialogs_en = {
  ...
  warn2:
    "However browser is unreliable data storage so it is highly recommended to store your game base manually by clicking button",
  warn3:
    "in top right corner in the end of your work session. This button downloads your game base file on your computer.",
