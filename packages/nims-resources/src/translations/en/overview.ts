export const overview_en = {
  ...
  "story-completeness-value2": "{{percent}}% ({{finished}} from {{all}} stories)",
  "general-completeness-value2": "{{percent}}% ({{finished}} from {{all}} subjective visions)",
  "relation-completeness-value2": "{{percent}}% ({{finished}} from {{all}} relations)",
  "consistency-problem-detected":
    "Detected base corruption during consistency check. Please contact developer to fix problems.",
