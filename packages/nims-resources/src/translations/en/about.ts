export const about_en = {
  "about-authors":
    "Program 'Larpwriter Toolkit NIMS' is written by Timofey Rechkalov (NtsDK) and Maria Sidekhmenova (Matilda).",
  "site-mention": "Author's site: ",
  "site-description":
    "You can find documentation, presentation, YouTube screencast playlist and social network links on author's site.",
  ...
  var072:
    "Version 0.7.2 (26 Jul 2018) - English release for Ropecon 2018. Added MDoL and LARP design cards. Fixed English translation.",
