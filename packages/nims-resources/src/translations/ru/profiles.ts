export const profiles_ru = {
  ...
  "add-enum-value": "Добавить значение",
  ...
  "error-prohibited-to-use-commas":
    "Запятые нельзя использовать в перечислении. Эта ошибка будет исправлена в будущем.",
  ...
  "player-has-no-character-and-can-create-it":
    "У вас нет привязки к персонажу, но вы можете создать персонажа самостоятельно.",
  "player-has-no-character-and-cant-create-it":
    "У вас нет привязки к персонажу и вы не можете создать персонажа самостоятельно. Обратитесь к мастерам.",
  ...
  "are-you-sure-about-character-removing":
    "Вы уверены, что хотите удалить {0}? Все данные связанные с персонажем будут удалены безвозвратно.",
  "are-you-sure-about-character-removing2":
    "Вы уверены, что хотите удалить {{profileName}}? Все данные связанные с персонажем будут удалены безвозвратно.",
  "enter-player-name": "Введите имя игрока",
  "enter-new-player-name": "Введите новое имя игрока",
  "are-you-sure-about-player-removing":
    "Вы уверены, что хотите удалить {0}? Все данные связанные с игроком будут удалены безвозвратно.",

  // profile configurer errors
  "are-you-sure-about-removing-profile-item":
    "Вы уверены, что хотите удалить поле профиля {0}? Все данные связанные с этим полем будут удалены безвозвратно.",
  "are-you-sure-about-removing-profile-item2":
    "Вы уверены, что хотите удалить поле профиля {{profileName}}? Все данные связанные с этим полем будут удалены безвозвратно.",
  ...
  "new-enum-values-remove-some-old-values":
    "Новое значение единственного выбора удаляет предыдущие значения: {0}. Это приведет к обновлению существующих профилей. Вы уверены?",
  "are-you-sure-about-changing-profile-item-type":
    "Вы уверены, что хотите изменить тип поля профиля {0}? Все заполнение данного поле в досье будет потеряно.",
  "warning-change-profile-item-is-destructive": "Изменение типа поля досье удалит все данные в этом поле",
};
