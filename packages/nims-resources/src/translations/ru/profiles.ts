export const profiles_ru = {
  ...
  'error-prohibited-to-use-commas': 'Запятые нельзя использовать в перечислении. Эта ошибка будет исправлена в будущем.',
  ...
  'are-you-sure-about-character-removing2': 'Вы уверены, что хотите удалить {{profileName}}? Все данные связанные с персонажем будут удалены безвозвратно.',
  ...
  'are-you-sure-about-removing-profile-item2': 'Вы уверены, что хотите удалить поле профиля {{profileName}}? Все данные связанные с этим полем будут удалены безвозвратно.',
