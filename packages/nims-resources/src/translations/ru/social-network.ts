export const socialNetwork_ru = {
  ...
  "require-resources-warning":
    "Внимание! Отрисовка социальной сети требует большого количества ресурсов. Рекомендуем сохранить данные перед отрисовкой.",
  ...
  "profile-group2": "Досье: {{name}}",
  "filter-group2": "Группа: {{name}}",
};
