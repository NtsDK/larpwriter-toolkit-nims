export const briefings_ru = {
  ...
  "relation-from-to2": "Отношение {{fromCharacter}} к {{toCharacter}}",
  starterToEnder: "Активное отношение {0} к {1}",
  starterToEnder2: "Активное отношение {{fromCharacter}} к {{toCharacter}}",
  allies: "Союзники",
  allies2: "Союзники",
  directional: "Направленное отношение",
  neutral: "Знакомый",
  enderToStarter: "Активное отношение {1} к {0}",
  enderToStarter2: "Активное отношение {{toCharacter}} к {{fromCharacter}}",
  "are-you-sure-about-relation-removing":
    "Вы уверены, что хотите удалить отношение {0}? Все данные связанные с отношением будут удалены безвозвратно.",
  "are-you-sure-about-relation-removing2":
    "Вы уверены, что хотите удалить отношение {{relationName}}? Все данные связанные с отношением будут удалены безвозвратно.",
