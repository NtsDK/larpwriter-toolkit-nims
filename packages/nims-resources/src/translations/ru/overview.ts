export const overview_ru = {
  ...
  "story-completeness-value2": "{{percent}}% ({{finished}} из {{all}} историй)",
  "general-completeness-value2": "{{percent}}% ({{finished}} из {{all}} адаптаций)",
  "relation-completeness-value2": "{{percent}}% ({{finished}} из {{all}} отношений)",
  "consistency-problem-detected":
    "Проверка данных выявила нарушение целостности базы, пожалуйста свяжитесь с разработчиками для устранения проблемы.",
