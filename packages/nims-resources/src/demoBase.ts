...
export const DemoBase = {
  Meta: {
    ...
    description:
      "События фильма, как основа для ролевой игры. В этой базе изложен первый фильм из трилогии Властелин колец. Хронология событий взята из книги.",
  ...
  Characters: {
    ...
    Элронд: {
      ...
      Раса: "эльф",
      Биография:
        "Сын полуэльфа Эарендила (в свою очередь, сына эльфийки Идриль и человека Туора) и полуэльфийки Эльвинг (дочери Диора, полуэльфа, и эльфийки Нимлот), брат Элроса, муж Келебриан — дочери Галадриэли и Келеборна, отец Арвен, Элладана и Элрохира. ",
      "Вес, кг.": 72,
      "Умеет петь": false,
    ...
    Галадриэль: {
      ...
      Раса: "эльф",
      Биография:
        "Могущественнейшая из эльфийских владык, оставшихся в Средиземье после Войны Гнева. Владычица Лориэна.",
      "Вес, кг.": 53,
      "Умеет петь": false,
    ...
    Голлум: {
      ...
      Раса: "другое",
      Биография:
        "Существо небольшого роста, крайне тощее и с большими светящимися глазами. Упоминается, что в прошлом он жил на поверхности. Голлум ранее был хоббитом, но он не любил солнце и стремился в самую глубь.",
      "Вес, кг.": 34,
      "Умеет петь": false,
      Снаряжение: "",
      Статус: "Свободна",
  ...
  Stories: {
    ...
    "История Сарумана": {
      ...
      story:
        "Саурон и Саруман активно работают над своими темными планами. Саруман собирает армию орков и создает урук-хаев.",
      characters: {
        Саруман: {
          name: "Саруман",
          inventory: "",
  ...
  Log: [
    ...
    ["user", "Thu Oct 13 2016 19:10:09 GMT+0500 (Pakistan Standard Time)", "moveProfileItem", "[11,0]", '["begin"]'],
    [
      "user",
    ...
    ["user", "Thu Oct 13 2016 19:12:47 GMT+0500 (Pakistan Standard Time)", "createGroup", '["Нейтралы"]', '["begin"]'],
    ["user", "Thu Oct 13 2016 19:12:58 GMT+0500 (Pakistan Standard Time)", "createGroup", '["Эльфы"]', '["begin"]'],
    [
      "user",
    ...
    ["user", "Thu Oct 13 2016 19:16:33 GMT+0500 (Pakistan Standard Time)", "addBoardGroup", '["Эльфы"]', '["begin"]'],
    [
      "user",
  ...
  Relations: [
    ...
    },
    {
      ...
      essence: [],
      Саурон:
        "Не быть тебе королём.Не быть тебе королём.Не быть тебе королём.Не быть тебе королём.Не быть тебе королём.Не быть тебе королём.Не быть тебе королём.Не быть тебе королём.Не быть тебе королём.Не быть тебе королём.Не быть тебе королём.Не быть тебе королём.",
      Арагорн: "",
      starter: "Саурон",
      ender: "Арагорн",
    },
