...
exports.nameIsNotEmpty2 = R.curry((el, nameType, entityTypeKey) => () => (!R.equals('', el) ? null : ['errors-name-is-empty-string2', [nameType, entityTypeKey]]));
...
exports.renameEntityCheck = R.curry((fromName, toName, entityList) => exports.chainCheck([exports.removeEntityCheck(fromName, entityList),
