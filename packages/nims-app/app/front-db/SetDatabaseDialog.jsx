      ...
      <div className="modal-dialog" role="document">
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <div>
              <div className="backup-bases"></div>
              <div className="margin-bottom-16">
                <input type="radio" name="dbSource" value="demoBase" id="dbSourceDemoBase" className="hidden" />
                <label htmlFor="dbSourceDemoBase" className="radio-label-icon common-radio">
                  <span l10n-id="dialogs-demo-database"></span>
                  <span className="demo-base-name"></span>
                </label>
              </div>
              <div className="margin-bottom-16">
                <input type="radio" name="dbSource" value="emptyBase" id="dbSourceEmptyBase" className="hidden" />
                <label htmlFor="dbSourceEmptyBase" className="radio-label-icon common-radio">
                  <span l10n-id="dialogs-empty-database"></span>
                </label>
              </div>
