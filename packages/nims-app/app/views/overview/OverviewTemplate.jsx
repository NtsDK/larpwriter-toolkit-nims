        ...
        <div className="panel-body">
          <ul className="nav nav-pills margin-bottom-16">
            ...
            <li className="btn-default">
              <a href="#overview-diagrams" data-toggle="tab" l10n-id="overview-statistic-diagrams" />
            </li>
            <li className="btn-default">
              <a href="#profile-diagrams" data-toggle="tab" l10n-id="overview-profile-diagrams" />
            </li>
            <li className="btn-default ">
              <a href="#gears" data-toggle="tab">
                <span className="gearsButton fa-free fa-bold fa-margin-right" l10n-id="header-gears" />
              </a>
            </li>
            <li className="btn-default ">
              <a href="#sliders" data-toggle="tab">
                <span className="slidersButton fa-free fa-bold fa-margin-right" l10n-id="header-sliders" />
              </a>
            </li>
          </ul>
          ...
          <div className="tab-content clearfix">
                  ...
                  <div className="col-xs-3">
                    <table className="table table-bordered table-striped" style={{ width: "auto" }}>
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <span className="statisticsLabel" l10n-id="overview-character-count">
                              {" "}
                            </span>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
                            <span className="statisticsLabel" l10n-id="overview-player-count">
                              {" "}
                            </span>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
                            <span className="statisticsLabel" l10n-id="overview-story-count">
                              {" "}
                            </span>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
                            <span className="statisticsLabel" l10n-id="overview-group-count">
                              {" "}
                            </span>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
                            <span className="statisticsLabel" l10n-id="overview-event-count">
                              {" "}
                            </span>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
                            <span className="statisticsLabel" l10n-id="overview-user-count">
                              {" "}
                            </span>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
                            <span className="statisticsLabel" l10n-id="overview-first-event">
                              {" "}
                            </span>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
                            <span className="statisticsLabel" l10n-id="overview-last-event">
                              {" "}
                            </span>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
                            <span className="statisticsLabel" l10n-id="overview-symbol-count">
                              {" "}
                            </span>
                          </td>
                          <td>
                            <span className="statisticsValue" id="textCharacterNumber" />
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <span className="statisticsLabel" l10n-id="overview-story-completeness">
                              {" "}
                            </span>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
                            <span className="statisticsLabel" l10n-id="overview-general-completeness">
                              {" "}
                            </span>
                          </td>
                          <td>
                            <span className="statisticsValue" id="generalCompleteness" />
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <span className="statisticsLabel" l10n-id="overview-relation-completeness" />
                          </td>
                          <td>
                            <span className="statisticsValue" id="relationCompleteness" />
                          </td>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div className="col-xs-8">
                    ...
                    <div style={{ display: "flex", justifyContent: "center" }}>
                      <div style={{ flexGrow: 1, flexBasis: 0, textAlign: "center" }}>
                        <canvas
                          className="characterChart margin-bottom-8"
                          width="120"
                          height="100"
                          style={{ margin: "0 auto" }}
                        />
                      ...
                      <div style={{ flexGrow: 1, flexBasis: 0, textAlign: "center" }}>
                        <canvas
                          className="playerChart margin-bottom-8"
                          width="120"
                          height="100"
                          style={{ margin: "0 auto" }}
                        />
                      ...
                      <div style={{ flexGrow: 1, flexBasis: 0, textAlign: "center" }}>
                        <canvas
                          className="storyChart margin-bottom-8"
                          width="120"
                          height="100"
                          style={{ margin: "0 auto" }}
                        />
                      ...
                      <div style={{ flexGrow: 1, flexBasis: 0, textAlign: "center" }}>
                        <canvas
                          className="groupChart margin-bottom-8"
                          width="120"
                          height="100"
                          style={{ margin: "0 auto" }}
                        />
            ...
            <div className="tab-pane" id="profile-diagrams">
              ...
              <div
                className="alert character alert-info margin-bottom-8"
                l10n-id="advices-no-character-profile-items-for-diagram"
              />
              <div className="container-fluid">
              ...
              <div
                className="alert player alert-info margin-bottom-8"
                l10n-id="advices-no-player-profile-items-for-diagram"
              />
              <div className="container-fluid">
