...
import { getDiffExampleTemplate } from "./DiffExampleTemplate.jsx";
import { getShowDiffDialog } from "./ShowDiffDialog.jsx";
...
export const showDiffExample = () => {
  ...
  DBMS.getLog({
    ...
    .then((data) => {
      ...
      U.addEls(
        el,
        R.aperture(2, data.requestedLog).map((pair) => {
          const content = U.makeEl("div");
          ...
          const els = diff
            ...
            .map((pair2) => U.addClasses(U.addEl(U.makeEl("span"), U.makeText(pair2[0])), ["log-diff", pair2[1]]));
