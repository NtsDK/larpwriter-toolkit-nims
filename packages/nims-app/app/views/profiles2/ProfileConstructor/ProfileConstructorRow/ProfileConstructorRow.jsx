...
export class ProfileConstructorRow extends Component {
  ...
  render() {
    ...
    const { profileStructureItem, i, t, refresh } = this.props;
    ...
    return (
      <tr>
        ...
        <td>
          <span>{profileStructureItem.name}</span>
        </td>
        <td>
        ...
        <td>
          <Dropdown pullRight>
            ...
            <Dropdown.Menu>
              <MenuItem>{t("profiles.move-profile-item")}</MenuItem>

              <ModalTrigger
                modal={<RenameProfileItemDialog profileItemName={profileStructureItem.name} onRename={refresh} />}
              >
                <MenuItem>{t("profiles.rename-profile-item")}</MenuItem>
              </ModalTrigger>
              ...
              >
                <MenuItem>{t("profiles.change-profile-item-type")}</MenuItem>
              </ModalTrigger>
              ...
              <ModalTrigger
                modal={
                  <RemoveProfileItemDialog profileItemName={profileStructureItem.name} index={i} onRemove={refresh} />
                }
              >
                <MenuItem>{t("profiles.remove-profile-item")}</MenuItem>
              </ModalTrigger>
            </Dropdown.Menu>
          </Dropdown>
        </td>
