...
export function ChangeProfileItemTypeDialog(props) {
  const { profileItemName, onChange, profileItemType, ...elementProps } = props;
  ...
  return (
    ...
    >
      ...
      <InlineNotification type="warning">{t("profiles.warning-change-profile-item-is-destructive")}</InlineNotification>
    </FormDialog>
  );
}
