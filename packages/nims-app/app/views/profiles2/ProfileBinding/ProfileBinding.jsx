              ...
              <div className="row height-100p">
                <div className="col-xs-4 height-100p">
                  ...
                  {characterNames.length !== 0 && (
                    <>
                      <input
                        className="form-control character-filter tw-mb-4"
                        type="search"
                        placeholder={t("binding.character-search")}
                      />
                      <ProfileList
                ...
                <div className="col-xs-4 height-100p">
                  ...
                  {playerNames.length !== 0 && (
                    <>
                      <input
                        className="form-control player-filter tw-mb-4"
                        type="search"
                        placeholder={t("binding.player-search")}
                      />
                      <ProfileList
                ...
                <div className="col-xs-4 height-100p">
                  ...
                  <input
                    className="form-control binding-filter tw-mb-4"
                    type="search"
                    placeholder={t("binding.binding-search")}
                  />
