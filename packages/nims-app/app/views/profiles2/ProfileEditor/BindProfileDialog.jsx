...
export function BindProfileDialog(props) {
  const { onBind, primaryName, secondaryNames, profileBinding, ...elementProps } = props;
  ...
  const secondaryNamesList = secondaryNames.filter((value) => {
  ...
  return (
    <FormDialog
      {...elementProps}
      formId="bindProfileForm"
      title={t("binding.bind-character-n-player")}
      onSubmit={onSubmit}
    >
      <FormGroup>
