...
export function ProfileDropdown(props) {
  const { entity, primaryNames, secondaryNames, profileBinding, refresh } = props;
  ...
  return (
    <Dropdown>
      ...
      <Dropdown.Menu>
        <ModalTrigger modal={<RenameProfileDialog profileName={entity.primaryName} onRename={onRenameProfile} />}>
          <MenuItem>{t("profiles.rename-character")}</MenuItem>
        </ModalTrigger>
        {secondaryNames.length !== 0 && (
          ...
          >
            <MenuItem>{t("binding.bind-character-n-player")}</MenuItem>
          </ModalTrigger>
        )}
        <MenuItem divider />
        ...
        <ModalTrigger modal={<RemoveProfileDialog profileName={entity.primaryName} onRemove={onRemoveProfile} />}>
          <MenuItem>{t("profiles.remove-character")}</MenuItem>
        </ModalTrigger>
      </Dropdown.Menu>
    </Dropdown>
  );
