...
export function RelationReport(props) {
  ...
  useEffect(() => {
    dbms
      .getRelationsSummary({ characterName: id })
      .then((relationsSummary) => {
  ...
  return (
    <PanelCore className="relation-report" title={t("profiles.character-report-by-relations")}>
            ...
            {relationsSummary.relations.map((rel) => {
              ...
              return (
                <tr className="relation-report-row">
                  ...
                  />
                  <td className={`completeness ${finished ? "relation-finished" : "relation-unfinished"}`}>
                    {t(`constant.${finished ? "finished" : "unfinished"}`)}
                  </td>
