...
const filterNames = ["date", "user", "action", "params", "status"];
...
export class LogViewerV2 extends Component {
  ...
  render() {
    const { filters, logData, max, logSize, currentPage } = this.state;
    const { t } = this.props;
        ...
        <div className="panel panel-default">
          <div className="panel-body">
            <div className="flex-row">
              ...
              <div className="flex-0-0-auto" style={{ margin: "8px 0" }}>
                <button type="button" className="btn btn-primary clear-filter" onClick={this.clearFilter}>
                  {t("log-viewer.clear-filter")}
                </button>
              </div>
            </div>
              ...
              <tbody className="log-data">
                {logData.map((rowData) => (
                  <tr key={rowData[0]}>
                    ...
                    <td>
                      <span>{dateFormat(new Date(rowData[2]), "yyyy/mm/dd HH:MM:ss")}</span>
                    </td>
                    <td>
                      <span>{rowData[1]}</span>
                    </td>
