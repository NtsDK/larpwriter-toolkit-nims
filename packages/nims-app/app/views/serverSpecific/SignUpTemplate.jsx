...
export const SignUpTemplate = function () {
  return (
    <div
      className="sign-up-tab flex-row block"
      style={{ justifyContent: "center", height: "80vh", alignItems: "center" }}
    >
          ...
          <form className="sign-up-form entity-management" name="sign-up-form">
            <div className="input-group">
              <input
                ...
                l10n-placeholder-id="entrance-login"
                type="text"
              />
              <input
                name="password"
                ...
                id="input-password"
                className="form-control"
                l10n-placeholder-id="entrance-password"
              />
              <input
                ...
                id="confirm-password"
                className="form-control"
                l10n-placeholder-id="entrance-confirm-password"
              />
