...
export class RelationRow extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (fromCharacter !== prevProps.fromCharacter || toCharacter !== prevProps.toCharacter || rel !== prevProps.rel) {
      this.updateFinishState();
    }
  ...
  onDeleteConfirm() {
    const { fromCharacter, toCharacter, externalRefresh, dbms } = this.props;
    this.setState({
      showDeleteRequest: false,
    });
  ...
  setCharacterRelationText(e) {
    const { fromCharacter, toCharacter, dbms } = this.props;
  ...
  getTooltip(essenceName) {
    const { t, fromCharacter, toCharacter } = this.props;
    return <Tooltip id={essenceName}>{t(`briefings.${essenceName}2`, { fromCharacter, toCharacter })}</Tooltip>;
  }
  ...
  render() {
    const { showDeleteRequest, directChecked, reverseChecked, essence } = this.state;
    const {
      t,
      profiles,
      selectedProfileItem,
        ...
        <div className="to-character-data col-xs-3">
          ...
          <div>
            ...
            <ConfirmDialog
              ...
              message={t("briefings.are-you-sure-about-relation-removing2", {
                relationName: `${fromCharacter}-${toCharacter}`,
              })}
          ...
          <>
            ...
            <div className="reverse text-column col-xs-3">
              ...
              <textarea
                ...
                className="briefing-relation-area form-control"
                placeholder={t("briefings.relation-from-to2", {
