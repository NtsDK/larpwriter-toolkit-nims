  ...
  return (
    <div className="briefing-export-tab block">
          ...
          <fieldset className="margin-right-16">
            ...
            <div>
              ...
              <label htmlFor="toSeparateFileCheckbox" className="checkbox-label-icon common-checkbox">
                <span l10n-id="briefings-each-briefing-to-own-file" />
              </label>
            </div>
            <div>
              ...
              <label htmlFor="exportOnlyFinishedStories" className="checkbox-label-icon common-checkbox">
                <span l10n-id="briefings-export-only-finished-stories" />
              </label>
            </div>
          </fieldset>
              ...
              <div className="flex-0-0-auto margin-right-16">
                <div>
                  ...
                  <label htmlFor="exportAllCharacters" className="radio-label-icon common-radio">
                    <span l10n-id="briefings-print-all" />
                  </label>
                </div>
                <div>
                  ...
                  <label htmlFor="exportCharacterRange" className="radio-label-icon common-radio">
                    <span l10n-id="briefings-print-partly" />
                  </label>
                </div>
                <div>
                  ...
                  <label htmlFor="exportCharacterSet" className="radio-label-icon common-radio">
                    <span l10n-id="briefings-exact-character-select" />
                  </label>
                </div>
              </div>
              ...
              <div className="flex-0-0-auto margin-right-16">
                ...
                <div>
                  ...
                  <label htmlFor="exportStorySet" className="radio-label-icon common-radio">
                    <span l10n-id="briefings-exact-story-select" />
                  </label>
                </div>
              </div>
              <div className="flex-0-0-auto">
      ...
      <div style={{ display: "flex", marginRight: "8px" }}>
        <button
          type="button"
          className="navigation-button exportModeButton"
          id="simpleExport"
          l10n-id="briefings-simple-export"
        />
        <button
          type="button"
          className="navigation-button exportModeButton"
          id="advancedWordExport"
          l10n-id="briefings-advanced-docx-export"
        />
        <button
          type="button"
          className="navigation-button exportModeButton"
          id="advancedTextExport"
          l10n-id="briefings-advanced-txt-export"
        />
      </div>
      ...
      <div className="panel panel-default">
        <div className="panel-body">
          <div id="simpleExportContainer" className="exportContainer">
            <button
              type="button"
              className="btn btn-default btn-reduced"
              id="makeBriefingsByTime"
              l10n-id="briefings-make-docx-by-time"
            />
            <button
              type="button"
              className="btn btn-default btn-reduced"
              id="makeBriefingsByStory"
              l10n-id="briefings-make-docx-by-stories"
            />

            <button
              type="button"
              className="btn btn-default btn-reduced"
              id="makeInventoryList"
              l10n-id="briefings-make-inventory"
            />
          </div>
          ...
          <div id="advancedWordExportContainer" className="exportContainer">
            ...
            <button
              type="button"
              className="btn btn-default btn-reduced"
              id="makeDocxBriefings"
              l10n-id="briefings-make-export"
            />
          </div>
            ...
            <div className="row">
              <div className="col-xs-2">
                <div className="margin-bottom-16">
                  <button
                    type="button"
                    className="btn btn-default btn-reduced white-space-normal"
                    id="previewTextOutput"
                    l10n-id="briefings-preview"
                  />
                  <button
                    type="button"
                    className="btn btn-default btn-reduced white-space-normal"
                    id="showRawData"
                    l10n-id="briefings-raw-data"
                  />
                  <button
                    type="button"
                    className="btn btn-default btn-reduced white-space-normal"
                    id="convertToDocxTemplate"
                    l10n-id="briefings-convert-to-docx-template"
                  />
                  <button
                    type="button"
                    className="btn btn-default btn-reduced white-space-normal"
                    id="generateByDocxTemplate"
                    l10n-id="briefings-generate-by-docx-template"
                  />
                  <button
                    type="button"
                    className="btn btn-default btn-reduced white-space-normal"
                    id="makeCustomTextBriefings"
                    l10n-id="briefings-export"
                  />
                  <button
                    type="button"
                    className="btn btn-default btn-reduced white-space-normal"
                    id="makeMarkdownBriefings"
                    l10n-id="briefings-markdown-export"
                  />
                </div>
                <div>
