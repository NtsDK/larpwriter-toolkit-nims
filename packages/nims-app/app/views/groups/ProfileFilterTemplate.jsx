            ...
            <div className="panel-body">
              ...
              <div className="tab-content clearfix">
                ...
                <div className="tab-pane" id="profile-filter-columns">
                  <select multiple className="profile-item-selector form-control" />
                </div>
              </div>
            </div>
          </div>
...
export const MultiEnumFilter = function () {
  return (
    <div className="MultiEnumFilter">
      <select className="form-control multi-enum-filter-type" />
      <select className="form-control multi-enum-filter-content" multiple />
    </div>
  );
};
