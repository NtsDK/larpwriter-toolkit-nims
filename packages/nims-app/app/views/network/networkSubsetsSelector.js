...
export class NetworkSubsetsSelector {
  ...
  refresh(characterNames, storyNames, stories) {
    ...
    let selector = U.fillSelector(
      U.clearEl(U.queryEl("#networkSubsetsSelector")),
      UI.constArr2Select(Constants.objectSubsets)
    );
  ...
  getStoryNames() {
    ...
    if (Constants.objectSubsets[0] === value) {
      // all objects
    ...
    if (Constants.objectSubsets[2] === value) {
      //"selected stories"
