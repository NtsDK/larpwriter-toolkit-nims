                ...
                <div id="answerOne" className="panel-collapse collapse" role="tabpanel" aria-labelledby="">
                  <div className="panel-body">
                    <div className="margin-bottom-16">
                      <a
                        target="_blank"
                        href="https://nordiclarp.org/2018/05/29/larp-design-cards/"
                        l10n-id="gears-link-design-cards"
                      />
                    </div>
                    <div className="margin-bottom-16">
                    ...
                    <div className="margin-bottom-16">
                      <a
                        target="_blank"
                        href="http://lib.rpg.ru/index.php/%D0%A8%D0%B5%D1%81%D1%82%D0%B5%D1%80%D0%B5%D0%BD%D0%BA%D0%B0_%D1%80%D0%BE%D0%BB%D0%B5%D0%B9"
                        l10n-id="gears-link2"
                      />
                    </div>
                    <div>
                ...
                <div id="answerFive" className="panel-collapse collapse in" role="tabpanel" aria-labelledby="">
                  <div className="panel-body">
                    ...
                    <div className="form-check margin-bottom-16">
                      <input
                        id="gears-show-notes-checkbox"
                        className="form-check-input show-notes-checkbox hidden"
                        type="checkbox"
                        value=""
                      />
                      <label
                        className="form-check-label checkbox-label-icon common-checkbox"
                        htmlFor="gears-show-notes-checkbox"
                      >
                    ...
                    <div className="form-check margin-bottom-16">
                      <input
                        id="gears-physics-enabled-checkbox"
                        className="form-check-input physics-enabled-checkbox hidden"
                        type="checkbox"
                        value=""
                      />
                      <label
                        htmlFor="gears-physics-enabled-checkbox"
                        className="form-check-label checkbox-label-icon common-checkbox"
                      >
                ...
                <div id="answerThree" className="panel-collapse collapse" role="tabpanel" aria-labelledby="">
                  <div className="panel-body">
                    <div className="form-group">
                      <button
                        type="button"
                        className="physics-settings-button btn btn-primary"
                        l10n-id="gears-physics-editor"
                      />
                    </div>
                    <div className="form-group">
                    ...
                    <button
                      type="button"
                      className="custom-physics-settings-button btn btn-primary"
                      l10n-id="gears-apply-custom-settings"
                    />
                  </div>
                </div>
              </div>
                ...
                <div id="answerFour" className="panel-collapse collapse" role="tabpanel" aria-labelledby="">
                  <div className="panel-body">
                    <div className="form-check margin-bottom-8">
                      <input
                        id="gears-big-picture-checkbox"
                        className="form-check-input big-picture-checkbox hidden"
                        type="checkbox"
                        value=""
                      />
                      <label
                        htmlFor="gears-big-picture-checkbox"
                        className="form-check-label checkbox-label-icon common-checkbox"
                      >
                    ...
                    <a
                      href="#"
                      className="link get-image-button btn btn-default btn-reduced white-space-normal width-100p margin-bottom-16"
                      download="gears.png"
                      l10n-id="gears-download-image"
                    />
                    <br />
                    <button
                      type="button"
                      className="download-button btn btn-default btn-reduced white-space-normal width-100p margin-bottom-8"
                      l10n-id="gears-download-csv"
                    />
                    <br />
                    <button
                      type="button"
                      className="download-json-button btn btn-default btn-reduced white-space-normal width-100p margin-bottom-8"
                      l10n-id="gears-download-json"
                    />
                    <br />
                    <button
                      type="button"
                      className="download-graphml-button btn btn-default btn-reduced white-space-normal width-100p margin-bottom-8"
                      l10n-id="gears-download-yed"
                    />
                    <br />
                  </div>
                </div>
...
export const ConfigInnerBody = function () {
  return <div className="ConfigInnerBody configInner" />;
};
