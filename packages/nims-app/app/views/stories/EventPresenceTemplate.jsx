  ...
  return (
    <div id="eventPresenceDiv">
      <div className="panel panel-default">
        <div className="alert no-characters alert-info margin-bottom-8" l10n-id="advices-no-characters-in-story"></div>
        <div className="alert no-events alert-info margin-bottom-8" l10n-id="advices-no-events-in-story"></div>
        <div className="panel-body flex-row" style={{overflowX:"auto"}} >
          <div className="flex-0-0-auto margin-right-8">
            ...
            <select multiple id="eventPresenceSelector" className="form-control"></select>
          </div>
