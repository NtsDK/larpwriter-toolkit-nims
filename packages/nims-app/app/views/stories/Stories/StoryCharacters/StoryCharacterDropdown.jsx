...
export function StoryCharacterDropdown(props) {
  const { storyName, characterName, refresh, outOfStoryChars } = props;
  ...
  return (
    <Dropdown>
      ...
      <Dropdown.Menu>
        ...
        >
          <MenuItem>{t("stories.replace-character")}</MenuItem>
        </ModalTrigger>
        <MenuItem divider />
        <ModalTrigger
          modal={<RemoveStoryCharacterDialog storyName={storyName} characterName={characterName} onRemove={refresh} />}
        >
          <MenuItem>{t("stories.remove-character")}</MenuItem>
        </ModalTrigger>
      </Dropdown.Menu>
    </Dropdown>
  );
