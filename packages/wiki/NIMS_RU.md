...
При работе НИМС в server-режиме доступен MCP-сервер для подключения AI-ассистентов: редактирование базы, вводных и сюжета.

Инструкция по настройке на клиенте: [MCP_RU.md](MCP_RU.md)
